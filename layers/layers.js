...
var format_Deslizamientos_3 = new ol.format.GeoJSON();
var features_Deslizamientos_3 = format_Deslizamientos_3.readFeatures(json_Deslizamientos_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Deslizamientos_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Deslizamientos_3.addFeatures(features_Deslizamientos_3);
var lyr_Deslizamientos_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Deslizamientos_3, 
                style: style_Deslizamientos_3,
                popuplayertitle: 'Deslizamientos',
                interactive: true,
                title: '<img src="styles/legend/Deslizamientos_3.png" /> Deslizamientos'
            });
...
lyr_reaurbanaTezuitln_0.setVisible(true);lyr_RedVial_1.setVisible(true);lyr_Alturadeedificios_2.setVisible(true);lyr_Deslizamientos_3.setVisible(true);lyr_Hospitales_4.setVisible(true);lyr_Refugios_5.setVisible(true);
var layersList = [lyr_reaurbanaTezuitln_0,lyr_RedVial_1,lyr_Alturadeedificios_2,lyr_Deslizamientos_3,lyr_Hospitales_4,lyr_Refugios_5];
...
lyr_Deslizamientos_3.set('fieldAliases', {'id': 'id', 'Nombre': 'Nombre', 'Riesgo': 'Riesgo', });
...
lyr_Deslizamientos_3.set('fieldImages', {'id': 'TextEdit', 'Nombre': 'TextEdit', 'Riesgo': 'TextEdit', });
...
lyr_Deslizamientos_3.set('fieldLabels', {'id': 'hidden field', 'Nombre': 'header label - always visible', 'Riesgo': 'inline label - always visible', });
...
lyr_Refugios_5.on('precompose', function(evt) {
